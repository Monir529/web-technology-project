...
<div class="tab">
  ...
  <button class="tablinks" onclick="openTab(event, 'applytc')" id="defaultOpen">Apply Tc</button>
...
try {
	...
	$sql = "INSERT INTO tcapplicants (id,name,class,institute) VALUES ('".$_POST['id']."','".$_POST['name']."','".$_POST['class']."','".$_POST['institute']."')";
    ...
    echo"<hr/>";
    echo "<p style='color:green;' >Tc Apllication is Successful </p>";
    echo"<hr/>";
