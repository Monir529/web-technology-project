...
<div class="tab">
  ...
  <button class="tablinks" onclick="openTab(event, 'attendance')" id="defaultOpen">Take Attendance</button>
</div>
...
try {
  ...
  $conn->exec($sql);
    ...
    echo "<p style='color:green;' >Date has assigned </p>";
    }
catch(PDOException $e)
    {
      echo"<hr/>";
    echo "<p style='color:red;' >Date Can't Be The Same </p>";
    echo"<hr/>";
    }
...
$con=mysqli_connect("localhost","root","","aic");
  ...
  {
     echo "<tr>";
  echo "<td>".$row['date']."</td> <td>".$row['id200']."</td> <td>".$row['id201']."</td> <td>".$row['id202']."</td> <td>".$row['id203']."</td> <td>".$row['id204']."</td> <td>".$row['id205']."</td> <td>".$row['id206']."</td> <td>".$row['id207']."</td> <td>".$row['id208']."</td> <td>" .$row['id209']."</td> <td>".$row['id210']."</td>";
     echo "</tr>";
...
try {
  ...
  $conn->exec($sql);
    ...
    echo "<p style='color:green;'> Attendance Given </p> ";
    }
catch(PDOException $e)
    {
      echo "<hr/>";
    echo " <p style='color:red;' > Could not find given id.</p>";
    echo "<hr/>";
